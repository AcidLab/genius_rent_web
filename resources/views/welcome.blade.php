                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-r">
                        ...
                        <div class="card card-cascade cascading-admin-card">
                            ...
                            <!--Card Data-->
                            <div class="admin-up">
                                <i class="fa fa-line-chart default-color"></i>
                                <div class="data">
                                    <p>SUBSCRIPTIONS</p>
                                    <h4>200</h4>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-r">
                        ...
                        <div class="card card-cascade cascading-admin-card">
                            ...
                            <!--Card Data-->
                            <div class="admin-up">
                                <i class="fa fa-pie-chart info-color"></i>
                                <div class="data">
                                    <p>TRAFFIC</p>
                                    <h4>20000</h4>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-r">
                        ...
                        <div class="card card-cascade cascading-admin-card">
                            ...
                            <!--Card Data-->
                            <div class="admin-up">
                                <i class="fa fa-bar-chart deep-purple lighten-1"></i>
                                <div class="data">
                                    <p>ORGANIC TRAFFIC</p>
                                    <h4>2000</h4>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-12">
                                    ...
                                    <form class="form-inline mt-2 ml-2">
                                        ...
                                        <button class="btn btn-sm btn-indigo ml-2 px-2"><i class="fa fa-search"></i>  </button>
                                    </form>
